...
//        查询宠物信息表
        String sql = "select * from pet_store.pet_supply_information where Supply_Id=?";
        ...
        Supply petSupplyInformation=null;
        while (resultSet.next()) {
            petSupplyInformation=new Supply(resultSet.getObject(1).toString(),resultSet.getObject(2).toString(),resultSet.getObject(3).toString(),resultSet.getObject(4).toString(),resultSet.getObject(5).toString(),resultSet.getObject(6).toString(),resultSet.getObject(7).toString());
            list_order.add(petSupplyInformation);
            System.out.println(petSupplyInformation.toString());
        }
        request.setAttribute("all_pet_supply_information",list_order);
...
//        增加交易信息表
        ...
        String add_str_info="\'"+orderId.format(date)+"\',"+"\'"+petSupplyInformation.getSupplyName()+"\',"+"\'"+1+"\',"+"\'"+petSupplyInformation.getSupplyPrice()+"\',"+"\'"+orderMakeTime.format(date)+"\',"+"\'"+buyerId+"\',"+"\'"+"none"+"\'";
        ...
        session.setAttribute("price",petSupplyInformation.getSupplyPrice());
...
<div class="am-g bdfw_nr">
    ...
    <div class="am-u-sm-12">
        ...
        <c:forEach items="${all_pet_supply_information}" var="now_pet_information">
            <div class="bdfw_nr_block">
                <div class="bdfw_nr_block_l">
                    <div class="bdfw_nr_title">商品名称：${now_pet_information.supplyName}</div>
                    <div class="bdfw_nr_brief_info">
                        <span class="bdfw_nr_brief_moreinfo">订单号：${sessionScope.supplyId}</span>
                    </div>
                    <div class="bdfw_nr_brief_address">数量：1</div>
                    <div class="bdfw_nr_brief_address">价格：<div style="color: gold;font-size: 24px;font-weight: bold;">${now_pet_information.supplyPrice}</div></div>
