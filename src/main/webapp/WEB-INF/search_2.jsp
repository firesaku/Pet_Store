...
<c:forEach items="${all_pet_information}" var="now_pet_information">
    <section class="row-fadeIn-wrapper">
        <article class="row fadeIn nfl">
            <ul>
                <li>${now_pet_information.petId}</li>
                <li>${now_pet_information.petTypeName}</li>
                <li>${now_pet_information.petBirth}</li>
                <li>${now_pet_information.petAge}</li>
                <li>${now_pet_information.petPrice}</li>
            </ul>
