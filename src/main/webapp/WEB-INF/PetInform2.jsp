    ...
    <div class="am_tuya_content">
        ...
        <div class="am_tuya_content_r">
            ...
            <ul class="am_tuya_tag">
                ...
                <li><a href=""><span>猫咪</span>
                    <span style="color: gold;font-size: 24px;font-weight: bold;">600</span>
                </a></li>

            </ul>
            <div class="page_hot">
                <div><a href="BuyPet.jsp?petId=P15"><button class="button1">购买</button></a></div>
            </div>
