...
<div class="am_tuya">
  <div class="am_tuya_user">
    <div class="am_tuya_user_info">
      <div class="am_tuya_user_info_name">宠物名：</div>
  ...
  <div class="am_tuya_content">
    <div class="am_tuya_content_l">
      ...
      <div class="am_tuya_more">
        <div class="am_tuya_oneword">描述：可爱小猫咪</div>
    ...
    <div class="am_tuya_content_r">
      ...
      <ul class="am_tuya_tag">
        ...
        <li><a href=""><span>可爱小猫咪</span>
          <span style="color: gold;font-size: 24px;font-weight: bold;">700</span>
        </a></li>

      </ul>
      <div class="page_hot">
        <div><a href="BuyPet.jsp?petId=P16"><button class="button1">购买</button></a></div>
      </div>
