  ...
  <div class="am_tuya_content">
    <div class="am_tuya_content_l">
      ...
      <div class="am_tuya_more">
        <div class="am_tuya_oneword">描述：柴犬</div>
    ...
    <div class="am_tuya_content_r">
      ...
      <ul class="am_tuya_tag">
        ...
        <li><a href=""><span>中华田园犬</span>
          <span style="color: gold;font-size: 24px;font-weight: bold;">500</span>
        </a></li>

      </ul>
      <div class="page_hot">
        <div><a href="BuyPet.jsp?petId=P14"><button class="button1">购买</button></a></div>
      </div>
